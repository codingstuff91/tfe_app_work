      ...
      <div class="flex h-20 justify-between">
        <div class="flex">
          ...
          <div class="hidden md:ml-6 md:flex md:space-x-8">
            ...
            <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-gray-300 hover:text-gray-700">Notre équipe</a>
            <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-gray-300 hover:text-gray-700">Contact</a>
          </div>
        </div>
