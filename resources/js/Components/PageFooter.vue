<template>
     <div class="mx-auto max-w-7xl overflow-hidden px-6 mt-12 lg:px-8">
      ...
      <div class="mt-10 flex justify-center space-x-10">
        ...
        <div class="flex justify-center gap-4">
            ...
            <p class="mt-10 text-center leading-5 text-gray-500">Informations Légales</p>
    ...
    <div class="flex justify-center my-8">
        <Link
                ...
                <Link
                    :href="route('register')"
                    class="ms-4 font-semibold text-xs text-white hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    >Inscription</Link
                >
    </div>
</template>
