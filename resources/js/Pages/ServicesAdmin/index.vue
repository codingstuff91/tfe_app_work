<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
        <h2 class="mb-10 text-center font-semibold text-xl text-black leading-tight">Carte des services</h2>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-300">
                    <thead class="">
                        <tr>
                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-black sm:pl-6">Services</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-black">Description</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-black">Prix</th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-black">Réservation</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        <tr v-for="service in services">
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-black">{{ service.name }}</td>
